...
{\href{https://github.com/KrishnaYadati/Frequency-Modulation/tree/main/codes/input.py}
{/codes/input.py}}}
\end{center}
\end{enumerate}
...
K_{f} = \frac{\Delta f}{A_m} 
 ...
 \begin{figure}
\centering 
\includegraphics[width=\columnwidth]{../figs/fm.png} 
...
\begin{center}
\fcolorbox{red}{white}{\parbox{7.5cm}
{\href{https://github.com/KrishnaYadati/Frequency-Modulation/tree/main/codes/mod.py}
{/codes/mod.py}}}
\end{center}
...
\begin{center}
\fcolorbox{red}{white}{\parbox{7.5cm}
{\href{https://github.com/KrishnaYadati/Frequency-Modulation/tree/main/codes/fm.py}
{/codes/fm.py}}}
\end{center}
